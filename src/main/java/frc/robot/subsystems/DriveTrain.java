...
public class DriveTrain extends SubsystemBase {
  private final WPI_TalonSRX m_leftDrive = new WPI_TalonSRX(2);
  private final WPI_TalonSRX m_leftFollower = new WPI_TalonSRX(3);
  private final WPI_TalonSRX m_rightDrive = new WPI_TalonSRX(0);
  private final WPI_TalonSRX m_rightFollower = new WPI_TalonSRX(1);
  ...
  public DriveTrain() {
    ...
    m_leftFollower.set(ControlMode.Follower, 2);
    m_rightFollower.set(ControlMode.Follower, 0);
